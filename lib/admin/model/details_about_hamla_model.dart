...
//
//     final detailsHamlaModel = detailsHamlaModelFromJson(jsonString);

import 'dart:convert';

DetailsHamlaModel detailsHamlaModelFromJson(String str) =>
    DetailsHamlaModel.fromJson(json.decode(str));

String detailsHamlaModelToJson(DetailsHamlaModel data) =>
    json.encode(data.toJson());

class DetailsHamlaModel {
  Data? data;

  DetailsHamlaModel({this.data});

  factory DetailsHamlaModel.fromJson(Map<String, dynamic> json) =>
      DetailsHamlaModel(
...
class Employee {
  ...
  factory Employee.fromJson(Map<String, dynamic> json) => Employee(
        ...
        dateAccession: json["date_accession"] == null
            ? null
